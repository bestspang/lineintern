...
import { ArrowLeft, Wallet, Clock, AlertCircle, Calendar, TrendingUp, Banknote } from 'lucide-react';
import { usePortal } from '@/contexts/PortalContext';
import { supabase } from '@/integrations/supabase/client';
import { format, startOfMonth, endOfMonth, differenceInDays, isWeekend } from 'date-fns';
